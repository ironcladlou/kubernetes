...
func TestVirtualNodeScoping(t *testing.T) {
	...
	tests := []test{
		...
		},
		{
			...
			//
			// TODO: This fails. Owner will inherit dependent's namespace, and
			// dependent will be considered dangling and will be deleted. We should be
			// able to infer the scope using the RESTMapper with the owner.
			dependent: makeNode("Pod", "v1", "abcd", "dependent", "test"),
			owner: owner{
